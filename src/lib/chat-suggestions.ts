...
export const SUGGESTION_POOL = [
  ...
  "Surprise me: plan a Saturday in Chicago with one great lunch spot, one experience, and one hidden gem.",
  ...
  "I'm interviewing a CFO candidate. Run a trust check on tenure patterns, regulatory history, and reputation.",
  "Compare three hotels in Tokyo for cherry blossom season on value, location, and cleanliness.",
...
export function generateMockReply(userMessage: string): string {
  ...
  if (
    ...
    return verdict("green", [
      "**Saturday pick:** Start at a highly rated coffee roastery in the arts district, then a walking food tour ($45pp) with strong value and 4.8★ consistency.",
